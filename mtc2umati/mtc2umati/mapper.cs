...
public class MappedObject
{
    ...
    public string OpcDataType { get; set; }
    public string MtcPath { get; set; }
    public string MtcDataType { get; set; }
    public string MtcSubtype { get; set; }
    public object Value { get; set; }

    public MappedObject(string opcPath, string opcDataType, string mtcPath, string mtcDataType, string mtcSubtype, object value)
    {
        OpcPath = opcPath;
        OpcDataType = opcDataType;
        MtcPath = mtcPath;
        MtcDataType = mtcDataType;
        MtcSubtype = mtcSubtype;
        Value = value;
    }
}
...
public static class MappingLoader
{
    ...
    public static List<MappedObject>? LoadMapping(string filePath, string sheetName, string[] columnsToRead, params string[] columnsToIgnore)
    {
