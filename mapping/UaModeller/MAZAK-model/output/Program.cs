    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                // Start the server.
                ServerManager server = new umatiConnectMazakServerManager();
        ...
        static void ConfigureOpcUaApplicationFromCode()
        {
            ...
            application.ApplicationName = "umatiConnectMazak";
            application.ApplicationUri = "urn:localhost:ifw:umatiConnectMazak";
            application.ApplicationType = UnifiedAutomation.UaSchema.ApplicationType.Server_0;
            application.ProductName = "umatiConnectMazak";

            // configure certificate stores
            application.ApplicationCertificate = new UnifiedAutomation.UaSchema.CertificateIdentifier()
            {
                StoreType = "Directory",
                StorePath = @"%CommonApplicationData%\ifw\umatiConnectMazak\pki\own",
            ...
            {
                StoreType = "Directory",
                StorePath = @"%CommonApplicationData%\ifw\umatiConnectMazak\pki\trusted",
            };

            application.IssuerCertificateStore = new UnifiedAutomation.UaSchema.CertificateStoreIdentifier()
            {
                StoreType = "Directory",
                StorePath = @"%CommonApplicationData%\ifw\umatiConnectMazak\pki\issuers",
            };

            application.RejectedCertificatesStore = new UnifiedAutomation.UaSchema.CertificateStoreIdentifier()
            {
                StoreType = "Directory",
                StorePath = @"%CommonApplicationData%\ifw\umatiConnectMazak\pki\rejected",
            };
            ...
            application.TraceSettings = new TraceSettings()
            {
                ...
                TraceFile = @"%CommonApplicationData%\ifw\logs\umatiConnectMazak.log.txt",
                MaxLogFileBackups = 3,
            ...
            {
                ProductUri = "urn:ifw:umatiConnectMazak",
                ProductName = "umatiConnectMazak",
