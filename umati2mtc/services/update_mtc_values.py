...
from services.add_mtc_structure import (
    DeviceStreamError,
    MissingComponentStreamError,
    MissingElementError,
...
async def update_xml_with_values(
    mapped_objects, xml_state: XmlState, devicestream_name: str, mtc_ns: str
):
    """
    ...
    try:
        while True:
            for mapped_object in mapped_objects:
                ...
                print(
                    f"[UPDATING] Trying to update {mapped_object.mtc_path} (optional SubType {mapped_object.mtc_subtype}) with value: {mapped_object.value}"
                )
                ...
                if mapped_object.value is not None:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print(
                                f"\033[91m[ERROR] Error adding ComponentStream for {component}/{component_name}: {e}\033[0m"
                            )
                            continue
                        ...
                        try:
                            ...
                            print(
                                f"\033[91m[ERROR] Error adding element to stream: {e}\033[0m"
                            )
                            continue
